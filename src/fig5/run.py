...
Unknown Qa, estimate Qa with KF and find Pd and simulate harm
"""
...
def simulate(w,e=100,na=int(1000),debug=False):
    ...
    ## calculate optimal from true Qa
    ...
    for ee in range(e):
        ...
        for t in range(T):
            ...
            if ((fat>0).sum() == 0) or t == T-1:
                ...
                ## analytical harm of 
                acosts.append(analytical_cost(Qa, Pd))
                ## wass dist
...
if __name__ == '__main__':
    ...
    if args.save:
        save_dir = './fig5/data/stationary'
        if not os.path.exists(save_dir):
            os.makedirs(save_dir)
        
        # fig.savefig(os.path.join(save_dir,'est.png'))
