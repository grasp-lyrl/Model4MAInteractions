...
save_dir = './fig5/figures'
if not os.path.exists(save_dir):
    os.makedirs(save_dir)

fig.savefig(os.path.join(save_dir,'f5-qa.pdf'),bbox_inches='tight')
fig1.savefig(os.path.join(save_dir,'f5-pd.pdf'),bbox_inches='tight')
fig2.savefig(os.path.join(save_dir,'f5-wd.pdf'),bbox_inches='tight')
fig3.savefig(os.path.join(save_dir,'f5-harms.pdf'),bbox_inches='tight')
plt.show()